...
The independent English edition is complete. Both rendering modes build
successfully, the default is restored to `\beginnerstatementstrue`, and the
tracked German master has no changes.
...
| Inputs, including conditional statement inputs | 141 | 141 | Exact argument match |
...
The builds were run from `english/` with Tectonic 0.17.0 and Biber 2.17:

```sh
tectonic --keep-logs --keep-intermediates name.tex
```
...
- `English_Case_Study.pdf` -- beginner enabled, SHA-256
  `cbf13eed5ab416d961aa55dd796f671c1fd353d775791b2fb1e4496f454dd29d`
- `English_Case_Study_Scientific.pdf` -- beginner disabled, SHA-256
