\begin{figure}[H]
  ...
  \begin{tikzpicture}[node distance=8mm and 14mm]
    ...
    \node[caseBox,minimum width=34mm,below=of frontend] (health)
      {\texttt{/api/health}\\prozessbezogen};
    \node[caseBox,minimum width=34mm,right=of health] (readiness)
      {\texttt{/api/ready}\\abhängigkeitsbezogen};
    \node[caseOptional,minimum width=38mm,right=of readiness] (postgres)
    ...
    \draw[caseSecondaryFlow] (readiness) -- node[above,font=\sffamily\tiny] {SELECT 1, falls aktiv} (postgres);
