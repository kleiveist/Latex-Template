\begin{figure}[H]
  ...
  \begin{tikzpicture}[node distance=8mm and 26mm]
    ...
    \node[caseBox,minimum width=70mm,below=of $(browser)!0.5!(desktop)$] (frontend)
    ...
    \draw[caseFlow] (browser) -- node[left,font=\sffamily\tiny] {lädt} (frontend);
    \draw[caseFlow] (desktop) -- node[right,font=\sffamily\tiny] {hostet} (frontend);
